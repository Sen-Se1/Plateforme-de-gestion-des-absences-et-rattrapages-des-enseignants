...
from app.routers import auth, utilisateurs, departements, groupes, matieres, salles
# from app.routers import absences, rattrapages, emplois_du_temps, notifications, dashboard
