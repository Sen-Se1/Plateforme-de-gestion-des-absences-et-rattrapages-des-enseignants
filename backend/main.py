...
from app.routers import auth, utilisateurs, departements, groupes, matieres
# from app.routers import salles, absences, rattrapages, emplois_du_temps, notifications, dashboard
